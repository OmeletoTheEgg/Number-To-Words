...
public class Background extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        w = getWidth();
        h = getHeight();
        Color color1 = new Color(252, 98, 85);
        Color color2 = new Color(252, 140, 85);
    	...
    	for (int i = 0; i <= dotCount; i++) {
    		for (int j = i; j <= dotCount; j++) {
    			...
    			g2d.setColor(new Color(252, 140, 85, alpha).brighter());
    		...
    		g2d.setColor(new Color(252, 140, 85, 150).brighter());
